...
sudo pacman -S sddm plasma-desktop bluedevil kscreen konsole kate kwalletmanager dolphin kdegraphics-thumbnailers ffmpegthumbs plasma-pa gwenview plasma-systemmonitor 
